"""Implementation of the ``astraeval run`` subcommand."""
...
from astraeval.config.builder import build_eval_run
from astraeval.config.loader import load_yaml
from astraeval.config.schema import RunConfig
from astraeval.core.eval_run import RunResult
from astraeval.exceptions import ThresholdError
from astraeval.reports.html_report import write_html
from astraeval.reports.json_report import write_run


def run_command(args: argparse.Namespace) -> int:
    """Execute the ``astraeval run`` workflow and return an exit code.
    ...
    :rtype: int
    :raises astraeval.exceptions.ThresholdError: When at least one
        configured threshold was not met.
    :raises astraeval.exceptions.AstraevalError: For any other domain error
