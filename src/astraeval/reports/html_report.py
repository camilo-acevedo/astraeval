...
from astraeval.core.eval_run import RunResult, SampleResult
from astraeval.core.manifest import RunManifest
from astraeval.core.types import Response
from astraeval.metrics.base import MetricResult
...
def _render_html(result: RunResult, thresholds: Mapping[str, float]) -> str:
    ...
    return (
        ...
        f"<title>astraeval run {_e(result.manifest.run_id)}</title>"
...
def _render_header(manifest: RunManifest) -> str:
    ...
    return (
        ...
        '<div class="app-title">'
        '<span class="brand">``astraeval``</span>'
