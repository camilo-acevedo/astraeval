...
from astraea.core.eval_run import RunResult, SampleResult
from astraea.core.manifest import RunManifest
from astraea.core.types import Response
from astraea.metrics.base import MetricResult
...
def _render_html(result: RunResult, thresholds: Mapping[str, float]) -> str:
    ...
    return (
        ...
        f"<title>astraea run {_e(result.manifest.run_id)}</title>"
