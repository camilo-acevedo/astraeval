...
**Status:** alpha (v0.4.0) — feature-complete through Phase 4. The public API may still change before 1.0.
...
└── exceptions.py # LLMEvalsError hierarchy
